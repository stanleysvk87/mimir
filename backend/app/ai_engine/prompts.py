def build_recall_prompt(question: str, entries: list[dict]) -> str:
    ...
    return (
        ...
        "order. Answer the question by weaving the entries into connected, "
        "readable prose that explains what happened, how, and why (not just "
        "a bullet list restating each entry). Cite specific moments inline "
        "using their timestamp in brackets, e.g. [2026-07-22T21:15]. If the "
        "entries don't actually answer the question, say so plainly instead "
